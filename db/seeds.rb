...
puts "START"
thaBern = Candidate.find_by(last_name: "Sanders")
taxes = Category.find_by(name: "Taxes")
tweet_ids = thaBern.load_tweet_ids_for(taxes)
tweet_ids.each { |tweet_id| p tweet_id }
